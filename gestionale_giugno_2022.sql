...
--
-- Create schema gestionale_giu2022
--

CREATE DATABASE IF NOT EXISTS gestionale_giu2022;
USE gestionale_giu2022;
...
-- Dump della struttura di trigger gestionale_giu2022.orders_schedule_trigger
...
-- Dump della struttura di trigger gestionale_giu2022.orders_schedule_trigger_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
