...
--
-- Create schema gestionale_sett2026
--

CREATE DATABASE IF NOT EXISTS gestionale_sett2026;
USE gestionale_sett2026;
...
-- Dump della struttura di trigger gestionale_sett2026.orders_schedule_trigger
...
-- Dump della struttura di trigger gestionale_sett2026.orders_schedule_trigger_update
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
